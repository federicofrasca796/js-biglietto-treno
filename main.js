...
//add check if user typed numbers
if (isNaN(userAge) || isNaN(commuteKm)){
    console.log("You need to type numbers.")
    document.getElementById('ticket_price').innerHTML = `You need to type numbers.`;
}
